...
Les explications détaillées du contexte et quelqes notes sur l'algorithme sont sur la page suivante : http://www.xavierlamorlette.fr/clavier.

Ce programme est écrit en C++ :

* Il utilise certaines de nombreuses nouvelles fonctionnalités syntaxiques de C++11. Le développement a été fait avec gcc 4.8.2 (compilateur fournit avec Ubuntu 14.04).
