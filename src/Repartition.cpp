...
{
    // r�partition b�te : on prend les caract�res dans l'ordre qu'ils viennent
...
{
    // on trie d'abord les caract�res par ordre d�croissant de fr�quence
        ...
        const Repartition & iObjet)
{
    ...
    // on s�pare les caract�res par main, et on les trie par fr�quences d�croissantes
    ...
    // on regarde quels sont les bigrammes sur la meme main, ou bien alternant les mains, et on les trie par fr�quences d�croissantes
    // 0: m�me main, 1: mains diff�rentes
    ...
    {
        // trie par ordre d�croissant sur la deuxi�me valeur des paires
...
{
    // score de r�partition des caract�res entre les deux mains
    // = somme totale des fr�quences - | diff�rence entre les sommes des deux mains |`
    ...
    // = somme des fréquences des bigrammes sur une seule main
